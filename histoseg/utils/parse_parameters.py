...
def parseTrainConfig(config_file_path, train=True):
    """
    ...
    if train:
        ...
        print("Skipping Step 2 : Model parameters will be picked up from the weights file.")
    ...
    if "stain" in params["slide"]:
        params["slide"]["stain"] = params["slide"]["stain"]
    else:
        params["slide"]["stain"] = "H&E"
        print("Since modality of the stain was not mentioned, defaulting to H&E.")

    print("\n Step 3 - B : Checking whether the site of tissue was mentioned or not.")

    if "site" in params["slide"]:
        params["slide"]["site"] = params["slide"]["site"]
    else:
        params["slide"]["site"] = "All"
        print(
            "Since site of the stain was not mentioned, defaulting to All."
        )

    print("\n Step 3 - C : Checking whether segmentation type was given or not, defaulting to tumor")

    if "seg_type" in params["slide"]:
        params["slide"]["seg_type"] = params["slide"]["seg_type"]
    else:
        params["slide"]["seg_type"] = 512
        print("Since segmentation type of the stain was not mentioned, defaulting to tumor.")

    print("\n Step 3 - D : Checking whether the level was mentioned or not.")
    ...
    print("\n Step 3 - E : Checking whether level patch_size was given or not")
    ...
    if train:
        ...
        print("Skipping Step 4 since we are not optimizing anything on test time.")
    ...
    if "patience" in params["save_top_k"]:
        ...
        print("Skipping Step 5 since no callbacks are required on test time.")
