...
def _check_encoder(modelname):
    model_list = ['resnet18', 'resnet34', 'resnet50', 'resnet101', 'resnet152',
                  ...
                  'timm-efficientnet-b2', 'timm-efficientnet-b3',
                  'timm-efficientnet-b4', 'timm-efficientnet-b5',
...
def FetchModel(decoder='resnet34', encoder='unet', encoder_depth=5,
               encoder_weights='imagenet',
               decoder_channels=[256, 128, 64, 32, 16],
               decoder_use_batchnorm='inplace', decoder_attention_type='scse',
