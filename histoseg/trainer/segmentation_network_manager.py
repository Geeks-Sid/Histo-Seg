...
class Segment(ptl.LightningModule):
    def __init__(self, hparams):
        ...
        # Fetching the model
        decoder_channels = [int(hparams.decoder_base_filters)*(2**i)
        ...
        self.model = FetchModel(decoder=hparams.decoder,
    ...
    def configure_optimizers(self):
        self.optimizer = fetch_optimizer(self.hparams.optimizer,
                                    self.hparams.learning_rate,
                                    self.model)
        self.lr_scheduler = CosineAnnealingWarmRestarts(self.optimizer,
                                  	  	                T_0=5,
                                  	   	                T_mult=1,
                                  	 	                eta_min=1e-6,
                                   	   	                last_epoch=-1)
